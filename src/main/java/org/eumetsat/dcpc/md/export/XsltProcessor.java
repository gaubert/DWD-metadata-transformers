...
public class XsltProcessor
{
    ...
    // The prefix that will be applied to the transformed filename (default: no prefix)
    ...
    public XsltProcessor(File a_XsltFile, File a_OutputDir, String a_OutputFilePrefix) throws Exception
    {
        ...
        {
            throw new Exception("Error: " + this.m_XsltFile.getPath() + " XSLT file doesn't exist");
        }
    ...
    public static void main(String[] args)
    {
        ...
        /*try
        {
            ...
            else
            {
                ...
                {
                    System.out
                            .println("The argument specified is not a valid file: "
                                    + args[1]);
                }
                else
                {
